...
namespace Tanks.Complete
{
    ...
    public class PowerUpEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            minePrefab = serializedObject.FindProperty("m_MinePrefab");
            mineCount = serializedObject.FindProperty("m_MineCount");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (selectedType)
            {
                ...
                case PowerUp.PowerUpType.Invincibility:
                    EditorGUILayout.PropertyField(durationTime); 
                    break;
                case PowerUp.PowerUpType.MineLayer:
                    EditorGUILayout.PropertyField(minePrefab);
                    EditorGUILayout.PropertyField(mineCount);
                    break;
            }
